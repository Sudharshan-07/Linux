...
The following figure illustrates configuring an irq_domain by integrating three methods: no-map, linear, and Radix tree, each applied to interrupt controllers A, B, and C, respectively:
